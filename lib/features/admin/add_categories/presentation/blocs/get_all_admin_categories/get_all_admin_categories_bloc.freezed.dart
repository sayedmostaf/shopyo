...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( GetAllCategoriesResponse categoryModel)?  success,TResult Function()?  empty,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.categoryModel);case EmptyState() when empty != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( GetAllCategoriesResponse categoryModel)  success,required TResult Function()  empty,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case LoadingState():
return loading();case SuccessState():
return success(_that.categoryModel);case EmptyState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( GetAllCategoriesResponse categoryModel)?  success,TResult? Function()?  empty,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.categoryModel);case EmptyState() when empty != null:
...
class LoadingState implements GetAllAdminCategoriesState {
  const LoadingState();
...
class SuccessState implements GetAllAdminCategoriesState {
  const SuccessState({required this.categoryModel});
  

 final  GetAllCategoriesResponse categoryModel;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SuccessState&&(identical(other.categoryModel, categoryModel) || other.categoryModel == categoryModel));
}
...
@override
String toString() {
  return 'GetAllAdminCategoriesState.success(categoryModel: $categoryModel)';
}
...
@useResult
$Res call({
 GetAllCategoriesResponse categoryModel
});
...
/// Create a copy of GetAllAdminCategoriesState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? categoryModel = null,}) {

...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( FetchAllUsersEvent value)?  getAllUsers,TResult Function( SearchForUserEvent value)?  searchForUser,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case FetchAllUsersEvent() when getAllUsers != null:
return getAllUsers(_that);case SearchForUserEvent() when searchForUser != null:
return searchForUser(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( FetchAllUsersEvent value)  getAllUsers,required TResult Function( SearchForUserEvent value)  searchForUser,}){
final _that = this;
switch (_that) {
case _Started():
return started(_that);case FetchAllUsersEvent():
return getAllUsers(_that);case SearchForUserEvent():
return searchForUser(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( FetchAllUsersEvent value)?  getAllUsers,TResult? Function( SearchForUserEvent value)?  searchForUser,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case FetchAllUsersEvent() when getAllUsers != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( bool isNotLoading)?  getAllUsers,TResult Function( String? searchName)?  searchForUser,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case FetchAllUsersEvent() when getAllUsers != null:
return getAllUsers(_that.isNotLoading);case SearchForUserEvent() when searchForUser != null:
return searchForUser(_that.searchName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( bool isNotLoading)  getAllUsers,required TResult Function( String? searchName)  searchForUser,}) {final _that = this;
switch (_that) {
case _Started():
return started();case FetchAllUsersEvent():
return getAllUsers(_that.isNotLoading);case SearchForUserEvent():
return searchForUser(_that.searchName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( bool isNotLoading)?  getAllUsers,TResult? Function( String? searchName)?  searchForUser,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case FetchAllUsersEvent() when getAllUsers != null:
return getAllUsers(_that.isNotLoading);case SearchForUserEvent() when searchForUser != null:
...
class SearchForUserEvent implements GetAllUsersEvent {
  const SearchForUserEvent(this.searchName);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SearchForUserEventCopyWith<SearchForUserEvent> get copyWith => _$SearchForUserEventCopyWithImpl<SearchForUserEvent>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchForUserEvent&&(identical(other.searchName, searchName) || other.searchName == searchName));
}
...
/// @nodoc
abstract mixin class $SearchForUserEventCopyWith<$Res> implements $GetAllUsersEventCopyWith<$Res> {
  factory $SearchForUserEventCopyWith(SearchForUserEvent value, $Res Function(SearchForUserEvent) _then) = _$SearchForUserEventCopyWithImpl;
@useResult
$Res call({
 String? searchName
});
...
/// @nodoc
class _$SearchForUserEventCopyWithImpl<$Res>
    implements $SearchForUserEventCopyWith<$Res> {
  _$SearchForUserEventCopyWithImpl(this._self, this._then);

  final SearchForUserEvent _self;
  final $Res Function(SearchForUserEvent) _then;

/// Create a copy of GetAllUsersEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? searchName = freezed,}) {
  return _then(SearchForUserEvent(
freezed == searchName ? _self.searchName : searchName // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( LoadingState value)?  loading,TResult Function( SuccessState value)?  success,TResult Function( EmptyState value)?  empty,TResult Function( ErrorState value)?  error,TResult Function( SearchUserState value)?  search,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return error(_that);case SearchUserState() when search != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( LoadingState value)  loading,required TResult Function( SuccessState value)  success,required TResult Function( EmptyState value)  empty,required TResult Function( ErrorState value)  error,required TResult Function( SearchUserState value)  search,}){
final _that = this;
switch (_that) {
case LoadingState():
...
return error(_that);case SearchUserState():
return search(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( LoadingState value)?  loading,TResult? Function( SuccessState value)?  success,TResult? Function( EmptyState value)?  empty,TResult? Function( ErrorState value)?  error,TResult? Function( SearchUserState value)?  search,}){
final _that = this;
switch (_that) {
case LoadingState() when loading != null:
return loading(_that);case SuccessState() when success != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( List<UsersModel> userList)?  success,TResult Function()?  empty,TResult Function( String error)?  error,TResult Function( List<UsersModel> userList)?  search,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LoadingState() when loading != null:
...
return error(_that.error);case SearchUserState() when search != null:
return search(_that.userList);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( List<UsersModel> userList)  success,required TResult Function()  empty,required TResult Function( String error)  error,required TResult Function( List<UsersModel> userList)  search,}) {final _that = this;
switch (_that) {
case LoadingState():
return loading();case SuccessState():
return success(_that.userList);case EmptyState():
return empty();case ErrorState():
return error(_that.error);case SearchUserState():
return search(_that.userList);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( List<UsersModel> userList)?  success,TResult? Function()?  empty,TResult? Function( String error)?  error,TResult? Function( List<UsersModel> userList)?  search,}) {final _that = this;
switch (_that) {
case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.userList);case EmptyState() when empty != null:
...
class SearchUserState implements GetAllUsersState {
  const SearchUserState({required final  List<UsersModel> userList}): _userList = userList;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SearchUserStateCopyWith<SearchUserState> get copyWith => _$SearchUserStateCopyWithImpl<SearchUserState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchUserState&&const DeepCollectionEquality().equals(other._userList, _userList));
}
...
/// @nodoc
abstract mixin class $SearchUserStateCopyWith<$Res> implements $GetAllUsersStateCopyWith<$Res> {
